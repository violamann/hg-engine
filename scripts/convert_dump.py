...
def convert_entry(entry: Dict[str, Any]) -> Dict[str, Any]:
    ...
    hardcoded_mappings = {
        ...
        "SPECIES_WORMADAM_2": "SPECIES_500",
        "SPECIES_ROTOM_1": "SPECIES_503",
        "SPECIES_ROTOM_2": "SPECIES_504",
        "SPECIES_ROTOM_3": "SPECIES_505",
        "SPECIES_ROTOM_4": "SPECIES_506",
        "SPECIES_ROTOM_5": "SPECIES_507",
        "SPECIES_GIRATINA_1": "SPECIES_501",
        "SPECIES_SHAYMIN_1": "SPECIES_502",
